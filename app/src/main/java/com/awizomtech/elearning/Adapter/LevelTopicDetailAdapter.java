...
public class LevelTopicDetailAdapter extends RecyclerView.Adapter<LevelTopicDetailAdapter.MyViewHolder> {
    ...
    private List<LevelDetailModel> levelDetailTopicModelList;
    private Context mCtx;

    public LevelTopicDetailAdapter(Context baseContext, List<LevelDetailModel> levelDetailTopicModelList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final LevelDetailModel n = levelDetailTopicModelList.get(position);
