...
public class MySubcriptionAdapter extends RecyclerView.Adapter<MySubcriptionAdapter.MyViewHolder> {
    ...
    public MySubcriptionAdapter(Context baseContext, List<CourseListModel> courseListModelList) {
