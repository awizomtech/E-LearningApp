...
public class HomeQuizAdapter extends RecyclerView.Adapter<HomeQuizAdapter.MyViewHolder> {
    ...
    public HomeQuizAdapter(Context baseContext, List<QuizModel> quizModelList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.newquiz_list_adapter, parent, false);
